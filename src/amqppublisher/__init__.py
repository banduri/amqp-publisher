...
conparser.add_argument('-o', '--host', type=str, help = 'host or ip of amqp-server', metavar='<host>',
...
conparser.add_argument('--retry',type = int, help = 'Maximum number of retry attempts to connect to the server',
                    metavar = '<count>', default = 10)

conparser.add_argument('--retrydelay', type = int, help = 'Time to wait in seconds, before the next connection retry',
                    metavar = '<seconds>', default = 1)

conparser.add_argument('--sockettimeout', metavar='<seconds>', type = float, help = 'TCP Socket timeout in seconds',
                    default = 0.25)
